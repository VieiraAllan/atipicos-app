...
export const EQUIPE: Integrante[] = [
  { foto: require("../../assets/equipe/p1.png"), nome: "Lucas Concentino", cor: "#C9F0D4" },
  { foto: require("../../assets/equipe/p2.png"), nome: "Állan Ribeiro", cor: "#FFE0B0" },
  { foto: require("../../assets/equipe/p3.png"), nome: "Mayara Frazão", cor: "#D9D4FF" },
  { foto: require("../../assets/equipe/p4.png"), nome: "Victoria Cristina", cor: "#FFD0D0" },
  { foto: require("../../assets/equipe/p5.png"), nome: "Lucas de Maria", cor: "#BFE9EC" },
  { foto: require("../../assets/equipe/p6.jpg"), nome: "Gabriel Cassimiro", cor: "#FFE9A8" },
];
